...
activities = {
    ...
    "Debate Team": {
        "description": "Research issues and practice public speaking for competitions",
        "schedule": "Mondays, 4:00 PM - 5:30 PM",
        "max_participants": 16,
        "participants": ["karen@mergington.edu", "liam@mergington.edu"]
    },
    "Science Club": {
        "description": "Explore experiments and scientific projects together",
